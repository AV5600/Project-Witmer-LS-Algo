	...
	public static void main(String[] args) throws InterruptedException {
        ...
        for (int i = 1; i<=44 ; i++) {
			 ...
			 if (questionText.contains(question01) || questionText.contains(question02) ||
				 ...
				 questionText.contains(question05) || questionText.contains(question07) ||
				 ...
				 questionText.contains(question16) || questionText.contains(question20) ||
				 ...
				 questionText.contains(question28) || questionText.contains(question32) ||
			 ...
			 } else if (questionText.contains(question06) || questionText.contains(question09) ||
					    questionText.contains(question10) || questionText.contains(question11) ||
					    questionText.contains(question15) || questionText.contains(question17) ||
					    questionText.contains(question18) || questionText.contains(question19) ||
					    questionText.contains(question23) || questionText.contains(question26) ||
					    questionText.contains(question27) || questionText.contains(question29) ||
		...
		String expected_act_ref_colour_and_width = "width: 33.3333%; background-color: rgb(202, 252, 114);";
		...
		wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("(//div[@class='wit-result-progress-bar']//div[@class='wit-result-progress-bar-value'])[1]")));
				
		WebElement bar_result_colour_and_width_02 = driver.findElement(By.xpath("(//div[@class='wit-result-progress-bar']//div[@class='wit-result-progress-bar-value'])[1]"));
		...
		wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("(//p[@class='wit-result-progress-score'])[2]")));
				
		WebElement bar_result_text_02 = driver.findElement(By.xpath("(//p[@class='wit-result-progress-score'])[2]"));
		...
		String expected_sen_int_colour_and_width = "width: 16.6667%; background-color: rgb(202, 252, 114);";
				
		String expected_sen_int_text = "Intuitive";
		...
		wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("(//div[@class='wit-result-progress-bar']//div[@class='wit-result-progress-bar-value'])[2]")));
						
		WebElement bar_result_colour_and_width_03 = driver.findElement(By.xpath("(//div[@class='wit-result-progress-bar']//div[@class='wit-result-progress-bar-value'])[2]"));
		...
		wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("(//p[@class='wit-result-progress-score'])[3]")));
						
		WebElement bar_result_text_03 = driver.findElement(By.xpath("(//p[@class='wit-result-progress-score'])[3]"));
		...
		String expected_vis_ver_colour_and_width = "width: 66.6667%; background-color: rgb(116, 195, 212);";
						
		String expected_vis_ver_text = "Verbal";
		...
		WebElement bar_result_colour_and_width_04 = driver.findElement(By.xpath("(//div[@class='wit-result-progress-bar ls-progress-bar-left']//div[@class='wit-result-progress-bar-value'])[2]"));
